...
<body class="dark-sidenav">
    ...
    <div class="left-sidenav">
        ...
        <div class="brand">
            <a href="crm-index.html" class="logo">
                <span>
                    <img src="{{ URL::asset('images/logo-sm.png') }}" alt="logo-small" class="logo-sm">
                </span>
                <span>
                    <img src="{{ URL::asset('images/logo.png') }}" alt="logo-large" class="logo-lg logo-light">
                    <img src="{{ URL::asset('images/logo-dark.png') }}" alt="logo-large" class="logo-lg logo-dark">
                </span>
            </a>
        </div>
        <!--end logo-->
                ...
                <ul class="list-unstyled topbar-nav float-right mb-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-lg pt-0">
                            ...
                            <div class="notification-menu" data-simplebar>
                                ...
                                <a href="#" class="dropdown-item py-3">
                                    ...
                                    <div class="media">
                                        <div class="avatar-md bg-soft-primary">
                                            <img src="{{ URL::asset('images/users/user-4.jpg') }}" alt=""
                                ...
                                <a href="#" class="dropdown-item py-3">
                                    ...
                                    <div class="media">
                                        <div class="avatar-md bg-soft-primary">
                                            <img src="{{ URL::asset('images/users/user-5.jpg') }}" alt=""
                                                class="thumb-sm rounded-circle">
                                        </div>
                                        <div class="media-body align-self-center ml-2 text-truncate">
                                            <h6 class="my-0 font-weight-normal text-dark">Your order is placed</h6>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown"
                            ...
                            <img src="{{ URL::asset('images/users/user-5.jpg') }}" alt="profile-user"
                                    ...
                                    <div class="col-lg-5 ml-auto align-self-center">
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <img src="{{ URL::asset('images/widgets/project3.jpg') }}"
                                                    alt="" class="thumb-lg ml-3">
                                                <button class="btn btn-primary btn-sm change-avatar ml-3">Change
                                                    Avatar</button>
                                                <input id="fileupload" type="file" name="files[]" multiple
                                                    style='display: none;'>
                                            </div>
                                            <!--end form-group-->
                                            <h5 class="font-weight-normal my-5">There are many variations of passages
                                                of Lorem Ipsum available, but the majority have suffered alteration in
                                                some form, by injected humour, or randomised.</h5>
                                            <div class="form-group">
                                                <label for="team-leader">Project team members</label>
                                                <div class="img-group ml-3">
                                                    <a class="user-avatar user-avatar-group" href="#">
                                                        <img src="{{ URL::asset('images/users/user-3.jpg') }}"
                                                            alt="user" class="thumb-xs rounded-circle">
                                                    </a>
                                                    <a class="user-avatar user-avatar-group" href="#">
                                                        <img src="{{ URL::asset('images/users/user-5.jpg') }}"
                                                            alt="user" class="thumb-xs rounded-circle">
                                                    </a>
                                                    <a class="user-avatar user-avatar-group" href="#">
                                                        <img src="{{ URL::asset('images/users/user-10.jpg') }}"
                                                            alt="user" class="thumb-xs rounded-circle">
                                                    </a>
                                                    <a class="user-avatar user-avatar-group" href="#">
                                                        <img src="{{ URL::asset('images/users/user-4.jpg') }}"
                                                            alt="user" class="thumb-xs rounded-circle">
                                                    </a>
                                                </div>
                                                <!--end img-group-->
                                                <button type="button"
                                                    class="btn btn-primary btn-sm add-member ml-3 px-3">
    ...
    <script src="{{ URL::asset('pages/jquery.projects_new.init.js') }}"></script>
