                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-8">
                                <select class="select2 form-control" id="jenis_a4" name="jenis_a4">
                                    ...
                                    <option {{ old('jenis_a4') == 1 ? 'selected' : '' }} value="1">
                                        Anti
                                        Perundungan
                                    </option>
                                    <option {{ old('jenis_a4') == 2 ? 'selected' : '' }} value="2">Anti
                                        Korupsi
                                    </option>
                                    <option {{ old('jenis_a4') == 3 ? 'selected' : '' }} value="3">
                                        Anti
                                        Intoleransi
                                    </option>
                                    <option {{ old('jenis_a4') == 4 ? 'selected' : '' }} value="4">Anti
