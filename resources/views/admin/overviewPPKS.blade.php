...
@section('script')
    <script>
        ...
        function createTable(valid, tahun) {
            console.log(valid, tahun)
            $.ajax({
                url: '/api/admin/overview/ppks/' + valid + '/' + tahun,
                type: 'GET',
            ...
            $('#myTable').DataTable({
                ajax: '/api/admin/overview/ppks/' + valid + '/' + tahun,
                columns: [{
                        data: 'npsn'
                    },
                    {
                    ...
                    {
                        data: 'instrumen_terlapor'
                    },
                    {
                        data: 'instrumen_jumlah'
                    },
                    {
                        data: 'capaian'
                    },
                    {
                        ...
                        render: function(data) {
                            return `<a href="overviewPPKS/` + data +
