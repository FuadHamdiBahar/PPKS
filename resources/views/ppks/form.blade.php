    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <!--end card-header-->
                <form action="/ppks" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label">Instrumen</label>
                            <div class="col-lg-9 col-xl-8">
                                <select class="select2 form-control" id="id_inpp" name="id_inpp" required>
                                    <option selected disabled>Pilih Instrumen</option>
                                    @foreach ($instrumen as $item)
                                        @if (old('id_inpp') == $item->id_inpp)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-8">
                                <input class="form-control" type="date" id="" name="tgl_berlaku"
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Persyaratan Laporan</h4>
                </div>
                <!--end card-header-->
                <div class="card-body">
